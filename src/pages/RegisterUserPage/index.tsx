    ...
    return (
        ...
        <PageCadastro>
            ...
            <BoxCadastro>
                ...
                <FormCadastro onSubmit={handleSubmit(handleCadastroSubmit)} className="formCadastro">
                    <DadosCadastro>
                        <span>Nome:</span>
                    ...
                    <TextCadastre>Já está cadastrado? <span className="loginAqui" onClick={()=>navigate("/login")}>Clique aqui </span>e entre na sua conta</TextCadastre>
